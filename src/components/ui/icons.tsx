...
export function LanguagesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function NextIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="currentColor"
      {...props}
      className={cn("w-4 h-4 fill-zinc-950 dark:fill-white", props.className)}
    >
      <title>Next.js</title>
